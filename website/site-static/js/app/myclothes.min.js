/*! myclothes - v0.0.1 - 2014-05-16 copyright by Sascha Häusler <saeschdivara@gmail.com> */ 
(function() {
    ...
    }), clothingApp.controller("BodyController", [ "$scope", "$timeout", "BodyPartResource", function($scope, $timeout, BodyPartResource) {
        var $controller, BodyController;
        return BodyController = function() {
            function BodyController() {
                this.$onClothingChosen = __bind(this.$onClothingChosen, this), this.body_data = {
                    head: "",
                    upper_body_part: "",
                    lower_body_part: "",
                    left_arm: "",
            ...
            return BodyController.prototype.$onClothingChosen = function(event, message) {
                ...
                return part ? (body_part_name = part.name.toLowerCase().replace(/[ ]/, "_"), $timeout(function(_this) {
                    return function() {
                        return _this.body_data[body_part_name] = clothing.image, $scope.$apply();
                    };
                }(this))) : void 0;
            }, BodyController;
        }(), $controller = new BodyController(), $scope.$on("CLOTHING_IS_CHOSEN", $controller.$onClothingChosen), 
        $scope.foo = "dddd", $scope.bodyData = $controller.body_data, $controller;
