/*! myclothes - v0.0.1 - 2014-05-15 copyright by Sascha Häusler <saeschdivara@gmail.com> */ 
(function() {
    ...
    }), clothingApp.controller("BodyController", [ "$scope", function($scope) {
        var $controller, BodyController;
        return BodyController = function() {
            function BodyController() {
                this.$onClothingChosen = __bind(this.$onClothingChosen, this);
            }
            return BodyController.prototype.$onClothingChosen = function(event) {
